...
#
# Создайте класс Movie и определите конструктор класса с такими параметрами, как заголовок,
# режиссер и год выпуска.
#
# Затем создайте такие объекты, как «Титаник» (реж. Джеймс Кэмерон, 1997), «Звездные войны»
# (реж. Джордж Лукас, 1977) и «Бойцовский клуб» (реж. Дэвид Финчер, 1999).
#
